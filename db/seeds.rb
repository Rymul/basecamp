...
ApplicationRecord.transaction do 
    ...
    # reviews for c1
    r1 = Review.create!(title: 'Best time of our lives!', body: 'This campsite is amazing! My family and I had a wonderful time exploring the area and spending time in the woods. The host was so lovely, ask her about her soup!', rating: 5, recomended: true, author_id: 2, campsite_id: 1)
    ...
    r5 = Review.create!(title: 'Was not very clean', body: 'I was told this would be a glamping experience. Instead, I had to sleep on the ground there was dirt and bugs everywhere.', rating: 3, recomended: false, author_id: 3, campsite_id: 2)
    ...
    r9 = Review.create!(title: "Incredible", body: "The property is beautiful such a nice place to wander, feel free and find some peace away from the cities!", rating: 5, recomended: true, author_id: 5, campsite_id: 3)
    # reviews for c4
    r10 = Review.create!(title: "Beautiful", body: "Had an awesome time. Will def. come back again.", rating: 5, recomended: true, author_id: 4, campsite_id: 4)
    ...
    r12 = Review.create!(title: "Our second time", body: "The Lost Coast Escape is an absolutely incredible site! We enjoyed our time and couldnt get over the views, hiking and just absolute tranquility.", rating: 5, recomended: true, author_id: 3, campsite_id: 4)
    # reviews for c5
    ...
    r18 = Review.create!(title: "Will definitely come back", body: "I enjoyed my time here. It was quiet for being near a road. I woke up briefly in the middle of the night was was very happy with how peaceful it was.", rating: 5, recomended: true, author_id: 2, campsite_id: 6)
    
    # r1 = Review.create!(title: , body: , rating: , recomended: , author_id: , campsite_id: )
    
    Campsite.all.each do |campsite|
        Review.create!(title: "This place is amazing", body: "The best escape from the city we have ever had", rating: 5, recomended: true, author_id: 1, campsite_id: campsite.id)
        Review.create!(title: "Wow", body: "You need to see this place. But come at the right time of year or bring lots of bug spray", rating: 4, recomended: true, author_id: 9, campsite_id: campsite.id)
        Review.create!(title: "I definitely recommend you go here", body: "The host is so polite and the location is spectacular.", rating: 5, recomended: true, author_id: 10, campsite_id: campsite.id)
    end
