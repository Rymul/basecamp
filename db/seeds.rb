...
ApplicationRecord.transaction do 
    ...
    c1.photos.attach(io: URI.open('https://base-camp-dev.s3.us-west-1.amazonaws.com/yosemite-colfax-spring-tent.jpg'), filename: 'yosemite-colfax-spring-tent.jpg')
    c1.photos.attach(io: URI.open('https://base-camp-dev.s3.us-west-1.amazonaws.com/yosemite-colfax-spring-picnictable.jpg'), filename: 'yosemite-colfax-spring-picnictable.jpg')
    c1.photos.attach(io: URI.open('https://base-camp-dev.s3.us-west-1.amazonaws.com/yosemite-colfax-spring-view.jpg'), filename: 'yosemite-colfax-spring-view.jpg')
    c1.photos.attach(io: URI.open('https://base-camp-dev.s3.us-west-1.amazonaws.com/yosemite-colfax-spring-cabin-bathrooms.jpg'), filename: 'yosemite-colfax-spring-cabin-bathrooms.jpg')
    #-----
